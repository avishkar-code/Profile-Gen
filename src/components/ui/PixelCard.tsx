...
const PixelCanvas = React.forwardRef<HTMLDivElement, PixelCanvasProps>(
    ({ gap = 5, speed = 35, colors = ["#f8fafc", "#f1f5f9", "#cbd5e1"], variant = "default", noFocus = false, style, ...props }, ref) => {
        React.useEffect(() => {
        ...
        const pixelCanvasElement = React.createElement('pixel-canvas', {
            'data-gap': gap,
            'data-speed': speed,
        ...
        return (
            ...
            >
                {pixelCanvasElement}
                {/* Render children on top of the canvas */}
